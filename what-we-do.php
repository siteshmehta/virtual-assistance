...
<body> 
        ...
        <div class="row">
            <div class="col-12 text-center pt-md-5 pt-md-2 ">
                 <font class="heading" style="font-size:30px" data-aos="fade-up" >
                     What can VS help you with?
                 </font>
                 <hr class="hr" data-aos="zoom-in" >
                 <p class="paragraph" data-aos="fade-up" >
                     Our Virtual Assistants are ready to assist you with business, executive, and personal tasks.
                 </p>
            </div>
        </div>
    </div>
    ...
    <div class="container p-1 p-md-5">
        <div class="row">
            <div class="col-12 text-center pt-md-5 pt-md-2 ">
                 <font class="heading" style="font-size:30px" data-aos="fade-up" >
                     What doesn't VS virtual service do ? 
                 </font>
                 <hr class="hr" data-aos="zoom-in"   >
                 <p class="paragraph" data-aos="fade-up" >
                     We, at VS Virtual Services are ready to assist with your tasks across the board, but
                ...
                <ul type="square" class="font-weight-bold" data-aos="fade-up" >
                    <li>
                         ...
                         <span class="text-secondary font-weight-normal">
                             ...
                             expense sheets, tax preparation, sourcing candidates, and much more but the payment
